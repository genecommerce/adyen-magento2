 ...
 */
namespace Adyen\Payment\Model\GooglePay\Helper;
...
class QuoteUpdater extends AbstractHelper
{
    ...
    private function updateBillingAddress(Quote $quote, array $details)
    {
        ...
        if(!isset($details['billingAddress']['locality']) || $details['billingAddress']['locality'] == "") {
            $details['billingAddress']['locality'] = $details['shippingAddress']['locality'];
        }
        if(!isset($details['billingAddress']['region']) || $details['billingAddress']['region'] == "") {
            $details['billingAddress']['region'] = $details['shippingAddress']['region'];
        }
